...
int main(int argc, char** argv) {
    ...
    string trained_classifier_location = "D:/UserData/z0047zpj/OpenCV/opencv/sources/data/haarcascades/haarcascade_smile.xml";//Defining the location our XML Trained Classifier in a string//
